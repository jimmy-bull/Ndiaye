                ...
                <View style={{
                    ...
                    <TouchableOpacity
                        ...
                        <Text style={{
                            ...
                            marginTop: 80, fontWeight: '700', zIndex: 3, position: 'absolute',
                        }}>Jean marc</Text>
                    </TouchableOpacity>
                    <View style={{ justifyContent: 'space-evenly', }}>
                        ...
                        <TouchableOpacity style={{
                            ...
                            justifyContent: 'center', flexDirection: "row", backgroundColor: 'orangered',
                            borderRadius: 5,
                        }}>
                            <Text style={{ color: 'white', margin: 5 }}>Refuser</Text>
                        </TouchableOpacity>
                    </View>
                </View>
                <View style={{
