...
export default function Comment({ navigation }) {
    return (
        <View style={{ flex: 1, backgroundColor:'white' }}>
            ...
            <View style={{ backgroundColor: 'whitesmoke', padding: 10, paddingRight: 10, paddingLeft: 10, alignItems: 'center', flexDirection: "row", justifyContent: "space-evenly", margin: 10, borderRadius: 30, marginBottom: 10 }}>
                <Image style={{ aspectRatio: 5 / 5, width: 40, borderRadius: 20, resizeMode: "cover", backgroundColor: "lightgray" }} source={{ uri: "https://www.rtl.be/info/GED/09580000/9587900/9587935.jpg", }} />
                <TextInput
                    style={styles.inputy}
